...
function Question_form() {
  ...
  const [documentName, setDocName] = useState("Form Heading");
          ...
          >
            <div>
              <div style={{ marginBottom: "0px" }}>
                <div style={{ width: "100%", marginBottom: "0px", marginTop: "5px"}}>
                  <DragIndicatorIcon
                    style={{
                      ...
                      <AccordionDetails className="add_question">
                        <div>
                          <div className="add_question_top">
                            ...
                            ></input>
                            <CropOriginalIcon style={{ color: "#5f6368" }} className="image"/>
                        ...
                        <div>
                          ...
                          <div className="add_question_body">
                            ...
                            >
                              {" "}
                              <BsFileText
                                style={{ fontSize: "20px", marginRight: "8px", color: "#6091d4" }}
                              />
                              Add Answer Feedback
                            </Button>
                          </div>
                    ...
                    {!ques.answer ? (
                      <div className="question_edit">
                        <AddCircleOutlineIcon
                          ...
                          className="edit add"
                        />
                        <CropOriginalIcon className="edit image" />
                        <TextFieldsIcon className="edit text" />
                      </div>
                    ) : (
                      ""
                    )}
